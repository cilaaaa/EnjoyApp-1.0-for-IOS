...
- (id)initWithFrame:(CGRect)frame numberOfStar:(int)number
{
    ...
    if (self) {
        ...
        self.starBackgroundView = [self buidlStarViewWithImageName:@"Rating-Star-"];
        self.starForegroundView = [self buidlStarViewWithImageName:@"Rating-Star"];
...
- (void)changeStarForegroundViewWithPoint:(CGPoint)point
{
    ...
    NSString * str = [NSString stringWithFormat:@"%f",p.x / (self.frame.size.width/self.numberOfStar)];
    NSInteger score = floor([str floatValue]+0.5);
